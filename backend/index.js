...
// Dummy users
const users = [
  { id: 1, name: 'Aryan', email: 'aryan@gmail.com', password: '12345', role: 'Reviewer' },
  { id: 2, name: 'Kittu', email: 'kittu@gmail.com', password: '54321', role: 'Author' }
];
...
// Test Route
app.get('/users', (req, res) => res.json(app.locals.users));
