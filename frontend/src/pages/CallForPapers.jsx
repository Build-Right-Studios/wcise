    ...
    <div className='md:p-6 p-4 text-[#1d3b58] font-sans max-sm:bg-white bg-[#1d3b58]'>
      <div className='bg-white flex flex-col items-center justify-center p-8'>
        ...
        <div className='flex md:flex-row  gap-4 flex-col items-center p-8'>
          ...
          <div className='bg-[#1d3b58] text-white h-auto w-80  md:text-2xl text-xl md:h-1/2 md:w-1/2 p-4 text-justify rounded-4xl '  ><p>Note: WCISE-2026 Submissions are solicited, but not limited to the following areas.</p></div>
        </div>
